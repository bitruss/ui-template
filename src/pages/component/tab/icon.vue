...
<div class="col-12">
    ...
    <h5 class="mb-4 mt-5">#WithIcons</h5>
    <b-tabs>
        <b-tab active>
            <template #title>
        ...
        <b-tab>
            ...
            <b-card-text>
                ...
                candy. Cookie powder marshmallow donut. Candy cookie sweet roll bear
                claw sweet roll. Cake tiramisu cotton candy gingerbread cheesecake
                toffee cake. Cookie liquorice dessert candy canes jelly.
            </b-card-text>
            <b-card-text>
        ...
        <b-tab disabled>
            ...
            <b-card-text>
                Halvah dessert fruitcake toffee oat cake tart oat cake topping jelly
                beans. Pudding sweet pie pastry lemon drops jujubes danish pie
                gingerbread. Liquorice powder wafer.
            </b-card-text>
        </b-tab>
        <b-tab>
            <template #title>
