...
<div class="col-12 mb-3">
    <b-card header="Custom">
       <div class="p-3"> 
            <b-overlay :show="show" rounded="sm">
                ...
                <template #overlay>
                    <div class="text-center">
                        <feather-icon size="21" icon="ClockIcon"  class="mt-3"/>
                        <p>
                            loading wait...
                        </p>
                    </div>
            ...
            <b-button :disabled="show" class="mt-3 mr-3" variant="outline-primary" @click="show = true">
                Show overlay
            </b-button>

            <b-button variant="primary" class="mt-3 mr-3" @click="show = !show">
                Toggle overlay
            </b-button>
       </div>    
    </b-card>
